...
skins.push({
	name:"025【一个不错的皮肤】推荐你试试",
	src:"pf/24.swf",
	width:560,
	height:420
});
skins.push({
	name:"026【VPlayer】自适应皮肤 带列表",
	src:"pf/26.swf",
	width:560,
	height:420
});
...
skins.push({
	name:"028【adult】CMP官方漂亮皮肤",
	src:"pf/28.swf",
	width:600,
	height:517
});
skins.push({
	name:"029【tvlive】CMP官方漂亮皮肤",
	src:"pf/29.swf",
	width:560,
	height:420
});
skins.push({
	name:"030【psp皮肤】CMP官方漂亮皮肤",
	src:"pf/30.swf",
	width:820,
	height:345
});
...
skins.push({
	name:"032【音乐皮肤】beveled",
	src:"pf/32.swf",
	width:350,
	height:200
});
skins.push({
	name:"033【音乐皮肤】mp3player",
	src:"pf/33.swf",
	width:320,
	height:400
});
skins.push({
	name:"034【音乐皮肤】scplayer",
	src:"pf/34.swf",
	width:290,
	height:25
});
...
function update() {
	...
	if (rtmp) {
		vars.push("rtmp=" + encodeURIComponent(rtmp));
	}
        //取得歌曲名字地址
	...
	if (logo) {
		vars.push("logo=" + encodeURIComponent(logo));
	}
        //取得背景图片地址
	var video_image = $("musicvideo_image").value;
	if (video_image) {
		vars.push("video_image=" + encodeURIComponent(video_image));
	}
        //取得公告内容地址
...
function getcmp(id, w, h, url, params) {
	...
	var htm = '<embed src="'+url+'&.swf" quality="high" width="'+w+'" height="'+h+'" wmode="transparent" align="middle" allowScriptAccess="always" allowFullScreen="true" mode="transparent" type="application/x-shockwave-flash"></embed>';
	return htm;
}